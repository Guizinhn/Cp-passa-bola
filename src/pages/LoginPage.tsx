...
export const LoginPage = () => {
  ...
  // pega a página que o usuário tentou acessar ou "/" se não tiver nada
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="bg-gray-700 text-white block w-full pl-10 pr-3 py-2 rounded-md focus:ring-2 focus:ring-purple-500 focus:outline-none"
